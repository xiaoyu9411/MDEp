...
#example for wPE: 
#Scenario 3
resultw3<-wpe.mean.sd(min.val=0.2, q1.val=2.2, med.val=4, q3.val=6.2, max.val=14, n=50)
resultw3$est.mean
resultw3$est.sd
resultw3$selected.dist  

#Scenario 2
resultw2<-wpe.mean.sd( q1.val=2.2, med.val=4, q3.val=6.2,  n=50)
resultw2$est.mean
resultw2$est.sd
resultw2$selected.dist  

#Scenario 1
resultw1<-wpe.mean.sd(min.val=0.2, med.val=4,  max.val=14, n=50)
resultw1$est.mean
resultw1$est.sd
...
#example for MDEp: 
#scenario 3 
result3<-MDEp.mean.sd(min.val=0.2, q1.val=2.2, med.val=4, q3.val=6.2, max.val=14, n=50)
result3$est.mean
result3$est.sd
...
#scenario 2 
result2<-MDEp.mean.sd( q1.val=2.2, med.val=4, q3.val=6.2, n=50)
result2$est.mean
result2$est.sd
result2$selected.dist

#scenario 3
result1<-MDEp.mean.sd(min.val=0.2, med.val=4, max.val=14, n=50)
result1$est.mean
result1$est.sd
